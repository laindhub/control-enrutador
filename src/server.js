    ...
    return {
      ...
      body: {
        ...
        release: {
          ...
          diagnosticRevision: 'demo-mobile-obsidian-graph-v39',
        },
        instance: {
        ...
        demoAi: {
          ...
          aiTransientRetries: 3,
          compactVideoPrompt: true,
          aiRateLimitFallback: true,
          ai429ImmediateFallback: true,
          ...
          mobileFullWidthActivityGraph: true,
        },
        demoWelcome: {
          accessible: authenticated && demoRole === 'ai',
